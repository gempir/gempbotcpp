...
void TwitchCommandLimit::AddCommand(const string command) {
    ...
    Lib::writeToLog("gempbotLog.txt", "{C++} Added command '" + Lib::formatForPrint(command) + "'.");
...
void TwitchCommandLimit::PushCommand(const string command) {
    Lib::writeToLog("gempbotLog.txt", "{C++} Attempting to push command '" + Lib::formatForPrint(command) + "'.");
...
void TwitchCommandLimit::SendCommand(const string command) {
    ...
    Lib::writeToLog("gempbotLog.txt", "{C++} Attempting to send command '" + Lib::formatForPrint(command) + "'.");
    if(!aSock->send(command.c_str())) {
        Lib::writeToLog("gempbotLog.txt", "{C++} Command delivery failed.");
